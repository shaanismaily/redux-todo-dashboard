  ...
  return (
    <>
      ...
      <select
        ...
        className="relative left-65 mt-3 bg-indigo-500 text-white pl-2 rounded"
      >
        ...
        <ul>
          {filteredTodos.map((todo) => (
            ...
            >
              ...
              <label
                htmlFor={todo.id}
                className={`text-white cursor-pointer w-full ml-2 ${todo.completed ? "line-through" : ""}`}
              >
                {editingId === todo.id ? (
                  <input
                    ref={inputRef}
              ...
              <div className="flex gap-2 align-middle">
                <button
                  ...
                  className={`text-white bg-green-500 border-0 py-1 px-4 focus:outline-none rounded text-md cursor-pointer ${todo.completed ? "opacity-10" : "hover:bg-green-600"}`}
                >
                  {editingId === todo.id ? (
                    // save icon
                    <svg
